...
{
    public class IndividussAPIController : ApiController
    {
        private TheBDDEntities db = new TheBDDEntities();

        // GET: api/IndividussAPI
        public IQueryable<Individus> GetIndividus()
        {
            return db.Individus;
        }

        // GET: api/IndividussAPI/5
